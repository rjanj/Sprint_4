...
class TestQuestions:
    ...
    def test_first_question(self, driver):
        ...
        question_one_text = question_one.click_question_and_take_answer(
            click=question_one.question_one_text,
            question=question_one.question_one_answer
        )
    ...
    def test_second_question(self, driver):
        ...
        question_two_text = question_two.click_question_and_take_answer(
            click=question_two.question_two_text,
            question=question_two.question_two_answer
        )
    ...
    def test_third_question(self, driver):
        ...
        question_three_text = question_three.click_question_and_take_answer(
            click=question_three.question_three_text,
            question=question_three.question_three_answer
        )
    ...
    def test_fourth_question(self, driver):
        ...
        question_four_text = question_four.click_question_and_take_answer(
            click=question_four.question_four_text,
            question=question_four.question_four_answer
        )
    ...
    def test_fifth_question(self, driver):
        ...
        question_five_text = question_five.click_question_and_take_answer(
            click=question_five.question_five_text,
            question=question_five.question_five_answer
        )
    ...
    def test_sixth_question(self, driver):
        ...
        question_six_text = question_six.click_question_and_take_answer(
            click=question_six.question_six_text,
            question=question_six.question_six_answer
        )
    ...
    def test_seventh_question(self, driver):
        ...
        question_seven_text = question_seven.click_question_and_take_answer(
            click=question_seven.question_seven_text,
            question=question_seven.question_seven_answer
        )
    ...
    def test_eight_question(self, driver):
        ...
        question_eight_text = question_eight.click_question_and_take_answer(
            click=question_eight.question_eight_text,
            question=question_eight.question_eight_answer
        )
